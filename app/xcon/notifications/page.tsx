...
import { Bell, Send, CheckCircle2, AlertCircle, Trash2, Users } from "lucide-react"
...
export default function XConNotificationsPage() {
  ...
  const sidebarItems = [
    { label: "Dashboard", href: "/xcon", icon: <Bell className="h-5 w-5" />, active: false },
    { label: "Leaders", href: "/xcon/leaders", icon: <Users className="h-5 w-5" />, active: false },
    { label: "Notifications", href: "/xcon/notifications", icon: <Bell className="h-5 w-5" />, active: true },
  ]
