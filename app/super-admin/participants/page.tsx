              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border bg-secondary/50">
                    <th className="px-6 py-3 text-left text-sm font-semibold text-foreground whitespace-nowrap">
                      Name
                    </th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-foreground whitespace-nowrap">
                      Email
                    ...
                    <th className="px-6 py-3 text-left text-sm font-semibold text-foreground whitespace-nowrap min-w-max">
                      X-CON Coordinator
                    </th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-foreground whitespace-nowrap">
                      Status
                    </th>
                    <th className="px-6 py-3 text-right text-sm font-semibold text-foreground whitespace-nowrap">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {participants.map((participant) => (
                    <tr key={participant.id} className="border-b border-border hover:bg-secondary/50 transition">
                      ...
                      <td className="px-6 py-4 text-sm text-muted-foreground whitespace-nowrap">{participant.email}</td>
                      <td className="px-6 py-4 text-sm text-foreground whitespace-nowrap">{participant.team}</td>
                      <td className="px-6 py-4 text-sm text-foreground font-medium whitespace-nowrap">
                        {participant.xconName}
                      </td>
